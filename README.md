...
The plugin icon ![](./plugin/src/main/resources/META-INF/pluginIcon.svg) and created by [eka ysdsgn](https://thenounproject.com/eka094/). The icon can be used in non-profit project and must attribute creator per Creative Commons license.
